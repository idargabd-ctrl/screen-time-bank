...
# арифметика: пять заданий — это 60 минут (миссии по 15, разборы по 10), и
# вместе с базой и домашкой (15 + 45) они ровно влезают в максимум 120. Показывать двадцать значило бы, что
...
# с ними день упирается в 195 (15 + 45 + 60 + 75). Решение владельца 12.09:
