...
DEFAULTS = {
    SETTING_BASE: "15",
    # 15 базовых + 45 за домашку + 60 за задания дня = 120, плюс до трёх
    # сложных заданий по просьбе по 20 = 180. Максимум — потолок для всего,
    # что ребёнок может заработать сам; больше предложить неоткуда.
    SETTING_DAILY_MAX: "180",
